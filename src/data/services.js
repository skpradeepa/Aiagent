...
const services = [
  {
    ...
    description: "Prompt-to-SQL conversion Live preview and safety validation...",
    video: video1
  },
  {
    image: img2,
    ...
    description: "Resume parsing and skill extraction AI-based candidate ranking...",
    video: video1
  },
   {
      image:img3,
  ...
  // Add all other services with `video`
];
